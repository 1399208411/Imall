  ...
  <header class="header">
    ...
    <div class="navbar">
      <div class="navbar-left-container">
        <a href="/">
          <img class="navbar-brand-logo" src="static/分期商城.svg" style="position:relative;width: 75px;height: 60px;left: 20px;top: 5px;"></a>
      </div>
    ...
    <div class="md-modal modal-msg md-modal-transition " v-bind:class="{'md-show':loginModalFlag}"><!--登录框-->
          ...
          <div class="confirm-tips">
            ...
            <ul>
              <li class="regi_form_input">
                ...
                <input type="text" name="loginname" v-model="userName" value="admin"
    ...
    <div class="md-overlay" v-if="loginModalFlag" @click="loginModalFlag=false"></div><!--遮罩层-->
  </header>
</template>
